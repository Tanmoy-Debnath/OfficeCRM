    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 well">
                ...
                <br/>
                {{ Form::open(['route' => 'add-franchisee', 'method'=>'POST']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <label class="control-label">
                            <select class="control-group" name='datee' id='datee' onchange="keyUp()">
                        ...
                        Month :
                        <label class="control-label">
                            <select name='monthh' id='monthh' onchange="keyUp()">
                                <option value='1'>1</option>
                                <option value='2'>2</option>
                                <option value='3'>3</option>
                                <option value='4'>4</option>
                        ...
                        Year :
                        <label class="control-label">
                            <select name='yearr' id='yearr' onchange="keyUp()">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <label class="control-label">
                            <select class="control-group" name='date' id='date' onchange="">
                                <option value='1'>1</option>
                                <option value='2'>2</option>
                                <option value='3'>3</option>
                                <option value='4'>4</option>
