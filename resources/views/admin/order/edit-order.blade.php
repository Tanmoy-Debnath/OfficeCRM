        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 well">
                    ...
                    {{ Form::open(['route'=>'update-order','method'=>'POST']) }}
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <select name='month' id='monthddl'>
                                <option value='{{ $order->month }}'>{{ $order->month }}</option>
                                <option value='1'>1</option>
                                <option value='2'>2</option>
                                <option value='3'>3</option>
                                <option value='4'>4</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $order->guest_id }}" name="guest_id" class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $order->order_no }}" name="order_no" class="form-control"/>
                                <span class="text-danger">{{ $errors->has('brand_name') ? $errors->first('brand_name') : ' ' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $order->order_amount }}" name="order_amount" class="form-control"/>
                                <span class="text-danger">{{ $errors->has('brand_name') ? $errors->first('brand_name') : ' ' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $order->order_due }}" name="order_due" class="form-control"/>
                                <span class="text-danger">{{ $errors->has('brand_name') ? $errors->first('brand_name') : ' ' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $order->reffered }}" name="reffered" class="form-control"/>
                                <span class="text-danger">{{ $errors->has('brand_name') ? $errors->first('brand_name') : ' ' }}</span>
                            </div>
                        </div>
